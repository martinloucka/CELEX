...
var LiveForm = {
	options: {
		...
		errorMessagePrefix: '<span class="fa fa-times-circle form-control-feedback"></span> ',// show this html before error message itself 
...
Nette.validateForm = function(sender) {
	...
	// added #generator
	var sElement = $(form).closest('.sForm').attr('data-name');
	if(sElement === undefined) sElement = $(form).closest('.sFormTrigger').attr('data-name');
	if(sElement === undefined) {} else sTriggerEnter($('.sFormsTrigger[data-name='+sElement+']'));
...
Nette.toggleControl = function(elem, rules, topSuccess, firsttime) {
	...
	var has = false, __hasProp = Object.prototype.hasOwnProperty, handler = function() {
		...
		// added #generator
		sTriggerEnter('.sFormsTrigger[data-name='+$(this).closest('.sForm').attr('data-name')+']');
	}, handled = [];
